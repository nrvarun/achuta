    ...
    <div className="py-10 md:py-16 xl:py-24">
      <div className="container mx-auto px-16 md:px-40 xl:px-60">
        ...
        <div className="mx-12 md:mx-24 mt-10 md:mt-16 xl:mt-24">
          <Text
            content="PROBLEM"
            classes="text-gray-500 mb-2 md:mb-4 xl:mb-6"
          />
        ...
        <div className="mx-12 md:mx-24 mt-10 md:mt-16 xl:mt-24">
          ...
          <ol className="list-decimal pl-4">
            <li className="mb-2">
              <Text content="A universal search query to show specified information" />
            </li>
            <li className="mb-2">
              <Text content="Primary navigation" />
            </li>
            <li className="mb-2">
              <Text content="Main content area (Stock details, portfolio, orders and postions, etc)" />
            </li>
            <li className="mb-2">
              <Text content="Static watchlist area to track trends at anytime" />
            </li>
          </ol>
        </div>
        <div className="mx-12 md:mx-24 mt-10 md:mt-16 xl:mt-24">
          ...
          <ol className="list-decimal mb-4 md:mb-8 xl:mb-12 pl-4">
            <li className="mb-2">
              <Text content="The flow must bring an intense and focused concentration to the task." />
            </li>
            <li className="mb-2">
              <Text content="It should so absorbing that the user is never distracted with the next step or the previous step." />
            </li>
            <li className="mb-2">
              <Text content="It must intuitive that the user always know what to do next." />
            </li>
          </ol>
          <Text
            classes="mb-4 md:mb-6 xl:mb-8"
        ...
        <div className="mx-12 md:mx-24 mt-10 md:mt-16 xl:mt-24">
          <h3 className="text-xl md:text-2xl xl:text-3xl sf-bold mb-3 md:mb-6 text-gold">
            Sticky Watchlist
          </h3>
          <Text
            classes="mb-4 md:mb-8 xl:mb-12"
          ...
          <ol className="list-disc mb-4 md:mb-8 xl:mb-12 pl-4">
            <li className="mb-2">
              <Text content="Users create baskets of securities which are carefully picked based on unique themes, strategies and objectives. To get the best outcomes, advanced traders monitor these baskets regularly and use those insights for their buy and sell decisions. Allowing users to always have a view of these regularily tracked securities in a watchlist seemed like a must have. " />
            </li>
            <li className="mb-2">
              <Text content="Seeing what is relevant is key for traders while building a watchlist, removing as much noise as possible." />
            </li>
            <li className="mb-2">
              <Text content="Making it easier to identify opputunities. With a watchlist, traders are able to easily identify trading opportunities, especially for short term traders." />
            </li>
          </ol>
          <Text
            classes="mb-4 md:mb-6 xl:mb-8"
