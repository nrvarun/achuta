  ...
  return (
    <section className="bg-black">
      <div className="container mx-auto pb-24 md:pb-28 xl:pb-36">
        <div className="max-w-lg sm:max-w-lg md:max-w-2xl xl:max-w-4xl 2xl:max-w-5xl hd:max-w-6xl mx-auto">
          <h2 className="text-2xl md:text-3xl xl:text-4.5xl 2xl:text-5xl hd:text-6xl text-center sf-medium text-white py-10 pb-16 md:py-20 xl:py-36 leading-smug xl:leading-loose px-5 md:px-16 xl:px-10">
